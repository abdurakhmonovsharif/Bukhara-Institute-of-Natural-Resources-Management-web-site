    ...
    if (childId) {
      AxiosCall("get", "/content/" + childId).then((data) => {
        ...
        data.contents?.map((item) => {
          ...
          if (obj.lan === "UZ") {
            localStorage.setItem("uz_content", objBody || "text");
            localStorage.setItem("uz_title", obj.title || "text");
            localStorage.setItem("uz_id", item.id || "text");
          } else if (obj.lan === "RU") {
            localStorage.setItem("ru_content", objBody || "text");
            localStorage.setItem("ru_title", obj.title || "text");
            localStorage.setItem("ru_id", item.id || "text");
          } else {
            localStorage.setItem("en_content", objBody || "text");
            localStorage.setItem("en_title", obj.title || "text");
            localStorage.setItem("en_id", item.id || "text");
          }
