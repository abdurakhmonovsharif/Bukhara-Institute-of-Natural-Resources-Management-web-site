      ...
      <div className="footer_contact">
        ...
        <div className="footer_contact_row">
          <div className="footer_contact_row_col">
            ...
            {lang == "uz" ? (
              <>
                <h4>Transportlar: 72, 236-avtobuslar yo`nalish taksilari.</h4>
              </>
            ) : lang == "en" ? (
              <>
                {" "}
                <h4>Transport: buses 72, 236, taxis.</h4>
              </>
            ) : (
              <>
                <h4> Транспорт: автобусы 72, 236, такси.</h4>
              </>
            )}
          </div>
          <div className="footer_contact_row_col">
        ...
        <div className="footer_contact_row2">
          ...
          <div className="footer-right-row">
            <div className="work-times">
              ...
              <div className="information-card">
                {lang == "uz" ? "Tushlik:" : lang == "ru" ? "Обед:" : "Lunch:"}{" "}
                13:00 - 14:00
              </div>
            </div>
            <div className="other">
